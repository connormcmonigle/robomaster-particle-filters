...
#include <plate_orbit_v2/observed_plate_orbit_builder.h>
#include <plate_orbit_v2/particle_filter_configuration_parameters.h>
#include <plate_orbit_v2/predicted_plate.h>
#include <plate_orbit_v2/prediction.h>
...
struct most_likely_particle_reduction_impl {
  ...
  struct orientation_and_z_coordinates_and_radii {
    float orientation;
  ...
  PF_TARGET_ONLY_ATTRS [[nodiscard]] inline state_type operator()(const state_type& a, const state_type& b) const noexcept {
    ...
    const pf::util::device_array<orientation_and_z_coordinates_and_radii, 5> candidates = {
        orientation_and_z_coordinates_and_radii{
            ...
            .radius_0 = a_particle.radius_0(),
            .radius_1 = a_particle.radius_1(),
        ...
        orientation_and_z_coordinates_and_radii{
            ...
            .radius_0 = a_particle.radius_1(),
            .radius_1 = a_particle.radius_0(),
    ...
    const auto [a_orientation, a_radius_0, a_radius_1, a_z_coordinate_0, a_z_coordinate_1] =
    ...
    const auto state = prediction(
        radius_0, radius_1, z_coordinate_0, z_coordinate_1, orientation, orientation_velocity, center, center_velocity);
...
class particle_filter_configuration {
 ...
 public:
  ...
  PF_TARGET_ONLY_ATTRS [[nodiscard]] prediction sample_from(util::default_rv_sampler& sampler, const observation& state)
    ...
    return prediction(
        radius_0, radius_1, z_coordinate_0, z_coordinate_1, orientation, orientation_velocity, center_xy, center_xy_velocity);
  }
