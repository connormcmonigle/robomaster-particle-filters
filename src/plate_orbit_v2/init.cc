...
void init(py::module_& m) noexcept {
  auto plate_orbit_v2 = m.def_submodule("plate_orbit_v2");

  py::class_<observed_plate>(plate_orbit_v2, "ObservedPlate")
  ...
  py::class_<particle_filter_configuration_parameters>(plate_orbit_v2, "ParticleFilterConfigurationParameters")
      .def(py::init<float, float, float, float, float, float, float, float, float, float, Eigen::Vector2f, Eigen::Vector2f>());

  py::class_<particle_filter>(plate_orbit_v2, "ParticleFilter")
